...
.. index:: Criação de um Servidor de Testes na AWS do CLVhealth-JCAFB-2021v-13 (Turnkey Linux) (*Odoo 13.0*)

=====================================================================================================
Criação de um Servidor de Testes na AWS do *CLVhealth-JCAFB-2021v-13* (*Turnkey Linux*) (*Odoo 13.0*)
=====================================================================================================
...
------------------
    ...
    #. Create, via TrunKey Hub, a new Key Pair:
        ...
        * Label: **clvheatlh-jcafb-2021v-13-aws-tst**
        * Private Key File: **clvheatlh-jcafb-2021v-13-aws-tst.pem**
    ...
    #. Create, via TrunKey Hub, the Amazon EC2 instance tk-postgres-aws:
        ...
        * Basics:
            ...
            * Hostname: **clvheatlh-jcafb-2021v-13-aws-tst**
        ...
        * Root account:
            ...
            * Root password: "*******"
            * SSH key-pair: **clvheatlh-jcafb-2021v-13-aws-tst**
        ...
        * `Using an SSH Tunnel <http://confluence.dbvis.com/display/UG91/Using+an+SSH+Tunnel>`_ 
        ...
        #. To  establisTrunKeyh a secure tunnel from the remote computer, use one the following commands (change the local port (5432) and the remote port (33335) appropriately):
            ...
            ::
                ...
                ssh -v -L 33335:localhost:5432 root@clvheatlh-jcafb-2021v-13-aws-tst

            ::

                ssh -L 33335:localhost:5432 root@clvheatlh-jcafb-2021v-13-aws-tst

            ::

                ssh -v -L 33335:127.0.0.1:5432 root@clvheatlh-jcafb-2021v-13-aws-tst

            ::

                ssh -L 33335:127.0.0.1:5432 root@clvheatlh-jcafb-2021v-13-aws-tst
...
-----------
    ...
    #. To install xlrd 1.1.0, execute the following commands (as root):
        ...
        ::
            ...
            root@clvheatlh-jcafb-2021v-13-aws-tst .../clvsol_clvhealth_jcafb/project# pip3 install xlrd
            Requirement already satisfied: xlrd in /usr/lib/python3/dist-packages (1.1.0)
            root@clvheatlh-jcafb-2021v-13-aws-tst .../clvsol_clvhealth_jcafb/project# pip3 install xlwt
            Collecting xlwt
            ...
            root@clvheatlh-jcafb-2021v-13-aws-tst .../clvsol_clvhealth_jcafb/project# pip3 install xlutils
            Collecting xlutils
...
-----------------------------------------
    ...
    #. Delete the 'Turnkeylinux Example ' database, using the following procedure:
        ...
        #. Open a web browser and type in the Odoo URL, in my case: http://clvheatlh-jcafb-2021v-13-aws-tst.
