...
.. index:: Criação de um Servidor Local do CLVhealth-JCAFB-2021 (Turnkey Linux) (Odoo 13.0)

======================================================================================
Criação de um Servidor Local do *CLVhealth-JCAFB-2021* (*Turnkey Linux*) (*Odoo 13.0*)
======================================================================================
...
--------------
    ...
    #. Create a new Virtual Machine using the following parameters:
        ...
        - Set a VM Name and a VM Location of your preference (**tkl-odoo13-jcafb21-vm** - **D:\\vm\\tkl-odoo13-jcafb21-vm**).
    ...
    #. Update host name, executing the following commands:
        ...
        ::
            ...
            HOSTNAME=tkl-odoo13-jcafb21-vm
        ...
        * `Using an SSH Tunnel <http://confluence.dbvis.com/display/UG91/Using+an+SSH+Tunnel>`_ 
        ...
        #. :red:`(Not Used)` To  establish a secure tunnel from the remote computer, use one the following commands (change the local port (5432) and the remote port (33335) appropriately):
            ...
            ::
                ...
                ssh -v -L 33335:localhost:5432 root@tkl-odoo13-jcafb21-vm

            ::

                ssh -L 33335:localhost:5432 root@tkl-odoo13-jcafb21-vm

            ::

                ssh -v -L 33335:127.0.0.1:5432 root@tkl-odoo13-jcafb21-vm

            ::

                ssh -L 33335:127.0.0.1:5432 root@tkl-odoo13-jcafb21-vm
...
-----------
    ...
    #. To install xlrd 1.1.0, execute the following commands (as root):
        ...
        ::
            ...
            root@tkl-odoo13-jcafb21-vm .../clvsol_clvhealth_jcafb/project# pip3 install xlrd
            Requirement already satisfied: xlrd in /usr/lib/python3/dist-packages (1.1.0)
            root@tkl-odoo13-jcafb21-vm .../clvsol_clvhealth_jcafb/project# pip3 install xlwt
            Collecting xlwt
            ...
            root@tkl-odoo13-jcafb21-vm .../clvsol_clvhealth_jcafb/project# pip3 install xlutils
            Collecting xlutils
...
-----------------------------------------
    ...
    #. Delete the 'Turnkeylinux Example ' database, using the following procedure:
        ...
        #. Open a web browser and type in the Odoo URL, in my case: http://tkl-odoo13-jcafb21-vm.
