...
Restaurar um backup do *CLVhealth-JCAFB-2020* no servidor "tkl-odoo12-jcafb-vm" (2019-07-15b)
---------------------------------------------------------------------------------------------
...
Atualizar o(s) módulo(s) [clv_employee] (2019-07-18 (a))
--------------------------------------------------------
...
Redefinir a senha do usuário de referência da JCAFB-2020 (2019-07-18)
---------------------------------------------------------------------
...
Atualizar as permissões de todos os Usuários da JCAFB-2020 (2019-07-18)
-----------------------------------------------------------------------
...
Criar um backup do *CLVhealth-JCAFB-2020* (2019-07-18a)
-------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [tkl-odoo12-jcafb-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2019-07-18a.sql

            gzip clvhealth_jcafb_2020_2019-07-18a.sql
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2019-07-18a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_2019-07-18a.tar.gz clvhealth_jcafb_2020

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2019-07-18a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_2019-07-18a.sql
        * /opt/odoo/clvhealth_jcafb_2020_2019-07-18a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2020_2019-07-18a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2019-07-18a.tar.gz

.. index:: clvhealth_jcafb_2020_2019-07-18a.sql
.. index:: filestore_clvhealth_jcafb_2020_2019-07-18a
.. index:: clvsol_filestore_clvhealth_jcafb_2019-07-18a

Restaurar um backup do *CLVhealth-JCAFB-2020* no servidor "tkl-odoo12-jcafb-vm" (2019-07-18a)
---------------------------------------------------------------------------------------------
