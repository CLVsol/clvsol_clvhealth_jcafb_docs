...
==============================================================================================
[2019-12-(09-11)] - Preparação do Banco de Dados - JCAFB-2020 - Servidor [tkl-odoo12-jcafb-vm]
==============================================================================================

Restaurar um backup do *CLVhealth-JCAFB-2020* no servidor "tkl-odoo12-jcafb-vm" (2019-12-08a)
---------------------------------------------------------------------------------------------
...
Atualizar o(s) módulo(s) [clv_document, clv_document_jcafb] (2019-12-11)
------------------------------------------------------------------------
...
Atualizar o(s) módulo(s) [clv_lab_test_jcafb_2020] (2019-12-11)
---------------------------------------------------------------
...
Instalar o(s) módulo(s) [clv_survey_jcafb_2020] (2019-12-11)
------------------------------------------------------------
...
Criar um backup do *CLVhealth-JCAFB-2020* (2019-12-11a)
-------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [clvheatlh-jcafb-2020-aws-pro] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2019-12-11a.sql

            gzip clvhealth_jcafb_2020_2019-12-11a.sql
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2019-12-11a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_2019-12-11a.tar.gz clvhealth_jcafb_2020

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2019-12-11a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_2019-12-11a.sql
        * /opt/odoo/clvhealth_jcafb_2020_2019-12-11a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2020_2019-12-11a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2019-12-11a.tar.gz

.. index:: clvhealth_jcafb_2020_2019-12-11a.sql
.. index:: filestore_clvhealth_jcafb_2020_2019-12-11a
.. index:: clvsol_filestore_clvhealth_jcafb_2019-12-11a
