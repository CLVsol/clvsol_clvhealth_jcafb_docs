    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_restore`.
    ...
    #. [tkl-odoo12-jcafb-vm] Executar os comandos de restauração dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            # gzip -d clvhealth_jcafb_2020_2019-10-09c.sql.gz

            dropdb -i clvhealth_jcafb_2020

            createdb -O odoo -E UTF8 -T template0 clvhealth_jcafb_2020
            psql -f clvhealth_jcafb_2020_2019-10-09c.sql -d clvhealth_jcafb_2020 -U postgres -h localhost -p 5432 -q

            # mkdir /var/lib/odoo/.local/share/Odoo/filestore
            cd /var/lib/odoo/.local/share/Odoo/filestore
            rm -rf clvhealth_jcafb_2020
            tar -xzvf /opt/odoo/filestore_clvhealth_jcafb_2020_2019-10-09c.tar.gz

            # mkdir /opt/odoo/clvsol_filestore
            cd /opt/odoo/clvsol_filestore
            rm -rf clvhealth_jcafb
            tar -xzvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2019-10-09c.tar.gz
