...
Atualizar os fontes do projeto (2020-01-13)
-------------------------------------------
...
Atualizar o(s) módulo(s) [clv_lab_test_jcafb_2020, clv_person_aux_jcafb] (2020-01-13)
-------------------------------------------------------------------------------------
...
Criar um backup do *CLVhealth-JCAFB-2020* (2020-01-13a)
-------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [clvheatlh-jcafb-2020-vm-pro] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-13a.sql

            gzip clvhealth_jcafb_2020_2020-01-13a.sql
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-13a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-13a.tar.gz clvhealth_jcafb_2020

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-13a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-13a.sql
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-13a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-13a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-13a.tar.gz

Atualizar o(s) módulo(s) [clv_lab_test_export] (2020-01-13)
-----------------------------------------------------------
    ...
    #. [clvheatlh-jcafb-2020-vm-pro] **Executar** a atualização do(s) Módulo(s):
        ...
        #. Estabelecer uma sessão ssh (session 2) com o servidor **clvheatlh-jcafb-2020-vm-pro** e executar o **install.py**:
            ...
            ::
                ...
                python3 install.py --super_user_pw "***" --admin_user_pw "***" --data_admin_user_pw "***" --db "clvhealth_jcafb_2020" - m clv_lab_test_export
...
Criar um backup do *CLVhealth-JCAFB-2020* (2020-01-13b)
-------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [clvheatlh-jcafb-2020-vm-pro] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-13b.sql

            gzip clvhealth_jcafb_2020_2020-01-13b.sql
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-13b.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-13b.tar.gz clvhealth_jcafb_2020

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-13b.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-13b.sql
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-13b.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-13b.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-13b.tar.gz

Criar um backup do *CLVhealth-JCAFB-2020* (2020-01-14a)
-------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [clvheatlh-jcafb-2020-vm-pro] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-14a.sql

            gzip clvhealth_jcafb_2020_2020-01-14a.sql
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-14a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-14a.tar.gz clvhealth_jcafb_2020

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-14a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-14a.sql
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-14a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-14a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-14a.tar.gz

Atualizar os fontes do projeto (2020-01-14)
-------------------------------------------
...
Criar um backup do *CLVhealth-JCAFB-2020* (2020-01-14b)
-------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [clvheatlh-jcafb-2020-vm-pro] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-14b.sql

            gzip clvhealth_jcafb_2020_2020-01-14b.sql
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-14b.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-14b.tar.gz clvhealth_jcafb_2020

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-14b.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-14b.sql
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-14b.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-14b.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-14b.tar.gz

Criar um backup do *CLVhealth-JCAFB-2020* (2020-01-15a)
-------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [clvheatlh-jcafb-2020-vm-pro] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-15a.sql

            gzip clvhealth_jcafb_2020_2020-01-15a.sql
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-15a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-15a.tar.gz clvhealth_jcafb_2020

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-15a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-15a.sql
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-15a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-15a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-15a.tar.gz

Criar um backup do *CLVhealth-JCAFB-2020* (2020-01-15b)
-------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [clvheatlh-jcafb-2020-vm-pro] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-15b.sql

            gzip clvhealth_jcafb_2020_2020-01-15b.sql
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2020-01-15b.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_2020-01-15b.tar.gz clvhealth_jcafb_2020

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020-01-15b.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-15b.sql
        * /opt/odoo/clvhealth_jcafb_2020_2020-01-15b.sql.gz
