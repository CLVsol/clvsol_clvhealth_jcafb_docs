...
Instalar o(s) módulo(s) [ver lista de módulos]
----------------------------------------------
...
--------------------------------------------------
    ...
    #. [tkl-odoo12-jcafb-vm] Configurar os *External Sync Schedules* disponíveis:
        ...
        #. Configurar, com a ajuda do *wizzard* *External Sync Schedule Mass Edit*, os *External Sync Schedules* disponíveis:
            ...
            * Lista de *Schedules*:
                * :ref:`Lista de Schedules 20190529a`
    ...
    #. [tkl-odoo12-jcafb-vm] Executar o *External Sync Batch* "**Default Batch**":
        ...
        #. Executar o *wizzard* *External Sync Batch Exec* para o "**Default Batch**":
            ...
            * *Synchronization Log*:
                * :ref:`External Sync Batch - Default Batch - 20190529a`
    ...
    #. [tkl-odoo12-jcafb-vm] Executar o *External Sync Batch* "**Default Batch**":
        ...
        #. Executar o *wizzard* *External Sync Batch Exec* para o "**Default Batch**":
            ...
            * *Synchronization Log*:
                ...
                * :ref:`External Sync Batch - Default Batch - 20190530a`
...
Criar um backup do *CLVhealth-JCAFB-2020* (2019-05-30a)
-------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [tkl-odoo12-jcafb-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2019-05-30a.sql

            gzip clvhealth_jcafb_2020_2019-05-30a.sql
            pg_dump clvhealth_jcafb_2020 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_2019-05-30a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_2019-05-30a.tar.gz clvhealth_jcafb_2020

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2019-05-30a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_2019-05-30a.sql
        * /opt/odoo/clvhealth_jcafb_2020_2019-05-30a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2020_2019-05-30a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2019-05-30a.tar.gz

.. index:: clvhealth_jcafb_2020_2019-05-30a.sql
.. index:: filestore_clvhealth_jcafb_2020_2019-05-30a
.. index:: clvsol_filestore_clvhealth_jcafb_2019-05-30a
