...
.. index:: Procura pela Família em Contatos (Procedimento)

====================================
Procura pela Família em **Contatos**
====================================
    ...
    #. **Caso um registro dessa Família seja encontrado** com *Address Type* :bi:`Family`, independentemente da existência de um registro com *Address Type* :bi:`Family (Aux)`:
        ...
        #. Utilizar o registro da Família apresentado na *view* :bi:`Families`.

        #. A Família é declarada como "**já cadastrada**".

    #. **Caso o registro dessa Família seja encontrado** somente com *Address Type* :bi:`Family (Aux)`:

        #. Abrir o registro de contato encontrado com *Address Type* :bi:`Family (Aux)` .

        #. Acionar o botão **[** :bi:`Family (Aux)` **]**.

        #. Utilizar o registro da Família apresentado na *view* :bi:`Families (Aux)`.
