...
.. index:: Recadastramento de uma Pessoa

=================================
**Recadastramento de uma Pessoa**
=================================

.. _Recadastramento de uma Pessoa:
...
.. _Fluxo de Trabalho (Workflow) do Recadastramento de uma Pessoa:

Fluxo de Trabalho (*Workflow*) do Recadastramento de uma Pessoa
---------------------------------------------------------------

Em linhas gerais, o processo de recadastramento de uma Pessoa segue o seguinte Fluxo de Trabalho (*Workflow*):

    #. :doc:`/user_guide/events/reregistration/reregistration_010`
    ...
    #. :doc:`/user_guide/events/reregistration/reregistration_020`
    ...
    #. :doc:`/user_guide/events/reregistration/reregistration_030`

    #. :doc:`/user_guide/events/reregistration/reregistration_040`
