...
========================================================================================
A Pessoa mudou-se para um Endereço fora da comunidade atendida pela JCAFB, sem a Família
========================================================================================
...
-----------------------------------------------
    ...
    * :bi:`Address (Aux)`:
        ...
        * *Contact Information* = Dados com informações que indiquem o novo Endereço fora da comunidade
...
------------------------------
    ...
    #. *View* :bi:`Address (Aux)`:
        ...
        #. Criar manualmente um novo registro :bi:`Address (Aux)`, preenchido com informações que indiquem o novo Endereço fora da comunidade.
    ...
    O processamento deste *Workflow* é executado utilizando o procedimento ":doc:`reregistration_procedure_020_010_075`".
