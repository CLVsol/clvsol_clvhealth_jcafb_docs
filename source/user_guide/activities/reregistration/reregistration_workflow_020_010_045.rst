...
.. index:: A Pessoa mudou-se para um Endereço já cadastrado sem a Família
...
--------
    ...
    O **Cadastro** identificado deverá conter os seguintes registros:
        ...
        * :bi:`Family` :green:`(nova)`: relativo à nova Família da Pessoa
...
-----------------------------------------------
    ...
    * :bi:`Family (Aux)`:
        ...
        * *Related Family* » :bi:`Family` :green:`(nova)`
        * *Contact Information* = Dados de Endereço de :bi:`Address` :green:`(novo)`
        * Outros Dados = Outros Dados de :bi:`Family` :green:`(nova)`

    * :bi:`Person (Aux)`:

        * *Address* » :bi:`Address` :green:`(novo)`
        * *Address (Aux)* » :bi:`Address (Aux)`
        * *Family* » :bi:`Family` :green:`(nova)`
...
------------------------------
    ...
    #. Registro :bi:`Person (Aux)`:
        ...
        #. Associar o registro :bi:`Family` :green:`(nova)` (associado ao registro :bi:`Address` :green:`(novo)`) ao campo *Family*, executando a Ação ":bi:`Person (Aux) Associate to Family`".
    ...
    O processamento deste *Workflow* é executado utilizando o procedimento ":doc:`reregistration_procedure_020_010_045`".
