...
-------------
    ...
    * *Workflow*: ":doc:`reregistration_workflow_020_010_060`".
    ...
    #. Editar o registro :bi:`Person (Aux)`:
        ...
        #. Remover as informações de *Contact Information*, utilizando o botão [:bi:`Clear Address Data`].

        #. Marcar o campo :bi:`Contact Information is unavailable`.

        #. Inserir no campo :bi:`Notes..` uma descrição que indique o desconhecimento do novo Endereço da Pessoa.
