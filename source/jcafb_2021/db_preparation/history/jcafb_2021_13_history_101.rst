...
---------------------------------------------------------
    ...
    #. Acessar a *View* *Funcionários*:
        ...
        * Menu de acesso:
        ...
        #. :red:`(Não Executado])` Redefinir a **Senha** de todos os Coordenadores novos da **JCAFB-2021v**.

:red:`(Não Executado])` Redefinir a senha do usuário de referência da JCAFB-2021v (2020-07-14)
----------------------------------------------------------------------------------------------
...
:red:`(Não Executado])` Restaurar um backup do banco de dados *CLVhealth-JCAFB-2021v-13* (2020-07-14a)
------------------------------------------------------------------------------------------------------
