...
==============================================================================
Migração do Banco de Dados - JCAFB-2020-NG - Servidor [tkl-odoo12-jcafb-ng-vm]
==============================================================================
...
Executar a Ação "*Model Export Execute*" para todos os "*Model Export*" disponíveis (2020-05-19)
------------------------------------------------------------------------------------------------

Criar um backup do banco de dados *CLVhealth-JCAFB-2020_NG* (2020-05-19a)
-------------------------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_backup`.
    ...
    #. [tkl-odoo12-jcafb-ng-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2020_ng -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_ng_2020-05-19a.sql

            gzip clvhealth_jcafb_2020_ng_2020-05-19a.sql
            pg_dump clvhealth_jcafb_2020_ng -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2020_ng_2020-05-19a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2020_ng_2020-05-19a.tar.gz clvhealth_jcafb_2020_ng

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020_ng_2020-05-19a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2020_ng_2020-05-19a.sql
        * /opt/odoo/clvhealth_jcafb_2020_ng_2020-05-19a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2020_ng_2020-05-19a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020_ng_2020-05-19a.tar.gz

.. index:: clvhealth_jcafb_2020_ng_2020-05-19a.sql
...
Restaurar um backup do banco de dados *CLVhealth-JCAFB-2020-NG* (2020-05-19a)
-----------------------------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_restore`.
    ...
    #. [tkl-odoo12-jcafb-ng-vm] Executar os comandos de restauração dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            # gzip -d clvhealth_jcafb_2020_ng_2020-05-19a.sql.gz

            dropdb -i clvhealth_jcafb_2020_ng

            createdb -O odoo -E UTF8 -T template0 clvhealth_jcafb_2020_ng
            psql -f clvhealth_jcafb_2020_ng_2020-05-19a.sql -d clvhealth_jcafb_2020_ng -U postgres -h localhost -p 5432 -q

            # mkdir /var/lib/odoo/.local/share/Odoo/filestore
            cd /var/lib/odoo/.local/share/Odoo/filestore
            rm -rf clvhealth_jcafb_2020_ng
            tar -xzvf /opt/odoo/filestore_clvhealth_jcafb_2020_ng_2020-05-19a.tar.gz

            # mkdir /opt/odoo/clvsol_filestore
            cd /opt/odoo/clvsol_filestore
            rm -rf clvhealth_jcafb
            tar -xzvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2020_ng_2020-05-19a.tar.gz
