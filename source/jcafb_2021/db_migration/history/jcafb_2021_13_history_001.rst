...
Criar um backup do banco de dados *CLVhealth-JCAFB-2021v-13* (2020-07-6a)
--------------------------------------------------------------------------
    ...
    #. [tkl-odoo13-jcafb21-vm] Executar os comandos de criação dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            pg_dump clvhealth_jcafb_2021v_13 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_13_2020-07-6a.sql

            gzip clvhealth_jcafb_2021v_13_2020-07-6a.sql
            pg_dump clvhealth_jcafb_2021v_13 -Fp -U postgres -h localhost -p 5432 > clvhealth_jcafb_2021v_13_2020-07-6a.sql

            cd /var/lib/odoo/.local/share/Odoo/filestore
            tar -czvf /opt/odoo/filestore_clvhealth_jcafb_2021v_13_2020-07-6a.tar.gz clvhealth_jcafb_2021v_13

            cd /opt/odoo/clvsol_filestore
            tar -czvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_13_2020-07-6a.tar.gz clvhealth_jcafb
    ...
    Criados os seguintes arquivos:
        * /opt/odoo/clvhealth_jcafb_2021v_13_2020-07-6a.sql
        * /opt/odoo/clvhealth_jcafb_2021v_13_2020-07-6a.sql.gz
        * /opt/odoo/filestore_clvhealth_jcafb_2021v_13_2020-07-6a.tar.gz
        * /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_13_2020-07-6a.tar.gz

.. index:: clvhealth_jcafb_2021v_13_2020-07-6a.sql
.. index:: clvhealth_jcafb_2021v_13_2020-07-6a.sql.gz
.. index:: filestore_clvhealth_jcafb_2021v_13_2020-07-6a
.. index:: clvsol_filestore_clvhealth_jcafb_2021v_13_2020-07-6a

:red:`(Não Executado])` Restaurar um backup do banco de dados *CLVhealth-JCAFB-2021v-13* (2020-07-6a)
------------------------------------------------------------------------------------------------------
    ...
    * Referência: :doc:`/setup/clvhealth_jcafb_restore`.
    ...
    #. [tkl-odoo13-jcafb21-vm] Executar os comandos de restauração dos arquivos de backup:
        ...
        ::
            ...
            cd /opt/odoo
            # gzip -d clvhealth_jcafb_2021v_13_2020-07-6a.sql.gz

            dropdb -i clvhealth_jcafb_2021v_13

            createdb -O odoo -E UTF8 -T template0 clvhealth_jcafb_2021v_13
            psql -f clvhealth_jcafb_2021v_13_2020-07-6a.sql -d clvhealth_jcafb_2021v_13 -U postgres -h localhost -p 5432 -q

            # mkdir /var/lib/odoo/.local/share/Odoo/filestore
            cd /var/lib/odoo/.local/share/Odoo/filestore
            rm -rf clvhealth_jcafb_2021v_13
            tar -xzvf /opt/odoo/filestore_clvhealth_jcafb_2021v_13_2020-07-6a.tar.gz

            # mkdir /opt/odoo/clvsol_filestore
            cd /opt/odoo/clvsol_filestore
            rm -rf clvhealth_jcafb
            tar -xzvf /opt/odoo/clvsol_filestore_clvhealth_jcafb_2021v_13_2020-07-6a.tar.gz
